...
```{r General Age Plot, echo=FALSE, fig.height=6, fig.width=6, warning=FALSE}
p <- my_data %>%
...
p + geom_point() + labs(title = 'Age of The Shooters over Time',
                        ...
                        color ='Gender',
                        shape = 'Prior Signs of Mental Health Issues') +
...
Now we take it off the plot to see how the original plot look like.
